...
public class LoggerContextTests
{
    ...
    public void GetLogger_ReturnsSameInstanceForSameCategory()
    {
        ...
        var logger1 = LogManager.GetLogger("MyCategory");
        var logger2 = LogManager.GetLogger("MyCategory");
    ...
    public void GetLogger_DifferentCategories_DifferentInstances()
    {
        ...
        var logger1 = LogManager.GetLogger("Cat1");
        var logger2 = LogManager.GetLogger("Cat2");
    ...
    public void GetLoggerGeneric_UsesTypeName()
    {
        ...
        var logger = LogManager.GetLogger<LoggerContextTests>();

        Assert.That(logger.Context.Category, Is.EqualTo("LoggerContextTests"));
    }
